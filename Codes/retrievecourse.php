...
#med{
    ...
    <div class="topnav">
        ...
        <a class="active" href="retrievecourse.php">COURSES</a>
...
<h3 style="color:black;">ENGINEERING</h3>
 <?php
  ...
  include "..\php\connection.php" ;
    ...
    $query = "SELECT Cname FROM course where Deg_code='ENG'";
	$result = mysqli_query($conn,$query);
	 //echo " ENGINEERING ","<br><br>";
	 
	 
	 while($value = mysqli_fetch_array($result))
	 { echo $value['Cname'] , "<br><br>";
...
<h3 style="color:black;">MEDICAL</h3>
 <?php
  ...
  include "..\php\connection.php" ;
    ...
    $query = "SELECT Cname FROM course where Deg_code='MED'";
	$result = mysqli_query($conn,$query);
	 //echo " MEDICAL ","<br><br>";
